// Tests src/PacketNoFall.js: the pure `shouldSpoofOnGround()` gate, and
// the registered `preMovementPacket` handler itself — driven directly via
// `getRegisteredHandler()` and a fake event from `@opal-scripts/stub`, per that
...
stub.installGlobals();
const { shouldSpoofOnGround } = require("../src/PacketNoFall.js");
