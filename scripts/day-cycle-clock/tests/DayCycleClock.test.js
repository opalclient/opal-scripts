...
// src/DayCycleClock.js — see the header comment there, and
// @opal-scripts/stub for why this require() works at all under plain Node.
"use strict";
...
const { ticksToHour, formatClock, phaseLabel, TICKS_PER_DAY } = require("../src/DayCycleClock.js");
