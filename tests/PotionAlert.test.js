// Tests character/PotionAlert.js: the pure label/duration/detail formatters,
// and the registered handlers themselves — driven via `getRegisteredHandler()`
// with world state staged through `stubState`, per opal-stub.js's header.
//
...
const { label, formatDuration, threatDetail, COMBAT_BUFFS } = require("../character/PotionAlert.js");
